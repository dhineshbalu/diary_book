...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
  ...
  $conn = new mysqli($servername,$username,$password,$dbname);
   ...
   $advise = $_POST["advise"];
     ...
     $stmt = $conn->prepare("insert into slamdata(username,clientname,nick,date,meet,wish,fav1,fav2,next,likes,mind,weak,strength,say,first,current,worst,advise) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
        $stmt->bind_param('ssssssssssssssssss',$us,$cs,$nick,$date,$meet,$wish,$fav1,$fav2,$next,$likes,$mind,$weak,$strength,$say,$first,$current,$worst,$advise);
