...
font-family: 'Sigmar One', cursive;
  ...
  <body>
    ...
    $sql = "select * from dairydata where username='".$_SESSION["username"]."' and date='".$date."'";

  $result = $conn->query($sql);
//  $row = $result->fetch_assoc();

     ?>
        <h1 class="text-center p1 animated infinite bounce">Your moments on this date</h1>
     <?php
     while(  $row = $result->fetch_assoc())
     {
       if($row["date"]==$date && $result->num_rows>0)
       {
      ?>

     <div class="container text-center p2">
     <img src="images/<?php echo $row["imagename"]; ?>" class="img-thumbnail" id="im1" width="300" height="200" >
...
<?php
 ...
 if($result->num_rows==0)
 {
   ?>
   <div class="container text-center p7">
    <h1>Oops, no moments on this date  </h1>
  <img src="3.png" width="300" class="p8" height="250">
   <?php
 }
   }
